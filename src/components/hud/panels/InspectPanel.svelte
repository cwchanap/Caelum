...
>
  ...
  {:else}
    <section class="panel-section building-panel" data-testid="building-panel">
      <h3 class="section-head"><span class="num">07</span> Building</h3>
      <p class="brief-id">{inspector.buildingLabel}</p>
