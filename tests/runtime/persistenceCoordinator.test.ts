...
/**
 * Shared counting backend used by `createCoordinatorHarness`. Provides call
 * counters and deterministic implementations of snapshot, dispatch, tick,
 * reset, createSandbox, snapshotForSave, and restoreSnapshot.
 */
